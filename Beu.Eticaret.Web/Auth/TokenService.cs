...
{
    public class TokenService  // tOKEN REFTOKEN üreten methotları içeriyor
    {
        ...
        private IEnumerable<Claim> GetClaims(pToken args, List<string> audiences)
        {
            var claimList = new List<Claim>
            {
                ...
                new Claim(ClaimTypes.Name,args.Name),
                new Claim("Surname",args.Surname.ToString()),
                new Claim("Password",args.Password.ToString()),
