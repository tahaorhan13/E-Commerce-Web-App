...
namespace Beu.Eticaret.Api.Account
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var tokenOptions = Configuration.GetSection(TokenOptions.TokenOption).Get<TokenOptions>(); // Appsettings'e eriþim yapýp içerisindeki Token Optiona ulaþabiliyor
            services.AddCustomTokenAuth(tokenOptions); // token'ý servisimize ekliyoruz
